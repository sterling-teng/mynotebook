...
1. [Th1520 & 开发板](#th1520--开发板)
2. [SG2042 & 开发板](#sg2042--开发板)
3. [Spacemit K1 & 开发板](#spacemit-k1--开发板)
4. [项目贡献与联系](#项目贡献与联系)
...
- 支持程度：
  - <span style="color:green">已支持（稳定）</span>：经过长期测试，功能稳定可用
  - <span style="color:orange">已支持（测试中）</span>：基本功能实现，需进一步验证兼容性
  - <span style="color:blue">开发中</span>：核心功能开发中，部分接口可调试
  - <span style="color:gray">计划中</span>：待排期开发，需求已明确
- 进度条：与对应支持程度颜色保持一致，直观匹配开发状态
- Mainline现状：
  - <span style="color:red">功能缺失/存在明显缺陷</span>
  - <span style="color:orange">功能基础但未优化</span>
  - <span style="color:green">功能完善（仅标注于完全适配场景）</span>
