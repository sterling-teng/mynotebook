...
## 项目概述
RVCK（RISC-V Custom Kernel）是基于Linux内核6.6.y的RISC-V架构同源项目，专注于为国产RISC-V SoC及开发板提供深度优化的内核支持。目前已完成**Th1520、SG2042、Spacemit K1**三款SoC及其开发板的同源适配，旨在弥合社区内核与国产硬件的适配鸿沟，加速RISC-V生态落地。
